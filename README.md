...
- [`examples/web-app/`](./examples/web-app) - todo app: JSON API over sqlite
  with HoneySQL, integrant and ruuter, an Alpine.js page served from
  `:resource-paths`, under `:lg-runtime :built`.

...
Wails is a `:go/*` dep, so the project needs `:lg-runtime :built` and a
let-go carrying the merged interop work - pin `:lg-version` to a main
sha, see [`lgx-go-wrappers.md`](./lgx-go-wrappers.md). Then:

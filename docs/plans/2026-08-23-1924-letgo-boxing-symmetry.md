...
- [ ] **Step 1: Rebuild the wrapper's runtime against this branch**
...
- [ ] **Step 2: Prove the shim's workarounds are now unnecessary**
...
- [ ] **Step 1: Fix the guide's two broken sketches** (use /writing-clearly)
...
- [ ] **Step 1: Cut a branch from upstream main**
...
- [ ] **Step 2: Provide the integration tree for verification**

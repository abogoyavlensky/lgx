...
- [ ] **Step 2: Replace the sql coord in all four files**
...
- [ ] **Step 3: Check the four coords are byte-identical**
...
- [ ] **Step 4: Verify the override applies under `lgx test`**
...
- [ ] **Step 5: Verify the examples are clean**
...
- [ ] **Step 1: Check CI still tests the working-tree sql**
...
- [ ] **Step 2: Tag the four packages on the same commit**
  ```

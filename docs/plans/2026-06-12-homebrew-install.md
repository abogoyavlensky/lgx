...
- [ ] **Step 2: Run against real release checksums**
  Run:
  ```sh
...
- [ ] **Step 3: Install end-to-end on Linux**
  Run:
  ```sh
...
- [ ] **Step 1: Add Homebrew subsection**
...
- [ ] **Step 1: Install from the pushed tap on Linux**
  Run:
  ```sh
  brew install abogoyavlensky/lgx/lgx
  lgx --version
...
- [ ] **Step 2: Hand off macOS check to Andrey**
